...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="1.1.0" xmlns:xlink="http://www.w3.org/1999/xlink" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:se="http://www.opengis.net/se">
  <NamedLayer>
    <se:Name>kr_ramsar</se:Name>
    <UserStyle>
      <se:Description>
        <se:Title>kkr.ramsar.default</se:Title>
        <se:Abstract>Kaardistiil Ramsari konventsiooni alade kuvamiseks.</se:Abstract>
      </se:Description>
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>kr_ramsar_25K-nK</se:Name>
          <se:MaxScaleDenominator>25000</se:MaxScaleDenominator>
          <se:PolygonSymbolizer>
            <se:Fill>
              <se:SvgParameter name="fill">#10aaaa</se:SvgParameter>
              <se:SvgParameter name="fill-opacity">0.05</se:SvgParameter>
            </se:Fill>
            <se:Stroke>
              <se:SvgParameter name="stroke">#10aaaa</se:SvgParameter>
        ...
        <se:Rule>
          <se:Name>kr_ramsar_50K-25K</se:Name>
        ...
        <se:Rule>
          <se:Name>kr_ramsar_200K-50K</se:Name>
        ...
        <se:Rule>
          <se:Name>kr_ramsar_nK-200K</se:Name>
